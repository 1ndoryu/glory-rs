...
fn detail_only_exposes_private_asset_urls_to_owner() {
    let record = SampleCatalogDetailRecord {
        ...
        /* [166A-1] Nuevos campos enriquecidos */
        cancion_origen_titulo: None,
        cancion_origen_slug: None,
        cancion_origen_artista: None,
        cancion_origen_whosampled_url: None,
        cancion_origen_bpm: None,
        relacion_sampleo_whosampled_id: None,
        extraccion_youtube_id: None,
        extraccion_spotify_id: None,
        extraccion_timing_inicio_seg: None,
        extraccion_bpm_detectado: None,
        extraccion_duracion_compas_seg: None,
        extraccion_compas_inicio_seg: None,
        extraccion_compas_fin_seg: None,
        extraccion_lado: None,
        extraccion_estado: None,
        extraccion_ruta_audio: None,
        extraccion_ruta_audio_completo: None,
        extraccion_metadata: None,
        extraccion_fuente_slug: None,
        extraccion_fuente_album: None,
        extraccion_destino_slug: None,
        extraccion_destino_album: None,
        creator_id: 77,
