...
pub use public::{
    get_artist, get_random_song, get_relation, get_relation_by_sample, get_song, get_song_chain,
    get_song_genres, get_song_samples, list_songs, relation_stats, search_songs, song_sections,
...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/canciones/aleatorio", get(get_random_song))
        .route("/canciones/generos", get(get_song_genres))
