...
pub use public::{
    ...
    relation_stats, search_songs, top_artists, top_songs,
};
...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/sample-discovery/relacion/:sample_id", get(get_relation_by_sample))
        .route("/sample-discovery/estadisticas", get(relation_stats))
        .route("/relaciones/:id", get(get_relation))
        .route("/relaciones/:id/vincular-sample", post(link_sample_to_relation))
        .route("/relaciones/:id/sample/:lado", delete(unlink_sample_from_relation))
        ...
        .route(
            "/admin/canciones/:id",
            put(update_song).delete(delete_song),
        )
