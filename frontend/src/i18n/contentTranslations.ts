...
export const contentEs: ContentTranslations = {
    ...
    plans: {
        ...
        'hosting-basico': {nombre: 'Básico', descripcion: 'WordPress pre-instalado, ideal para sitios personales y landing pages con tráfico moderado.', cta: 'Comenzar', features: ['WordPress pre-instalado', '5 GB almacenamiento SSD', 'SSL gratuito', 'Backups semanales', '1 dominio incluido', 'Soporte por chat', 'WP-CLI vía SSH', 'Actualizaciones WordPress']},
        'hosting-pro': {nombre: 'Pro', descripcion: 'WordPress optimizado para negocios en crecimiento que necesitan rendimiento y fiabilidad.', cta: 'Elegir Pro', features: ['WordPress pre-instalado', '20 GB almacenamiento SSD', 'SSL gratuito', 'Backups diarios', '3 dominios incluidos', 'CDN global', 'WP-CLI vía SSH', 'Staging environment']},
        'hosting-ecommerce': {nombre: 'E-commerce', descripcion: 'WordPress + WooCommerce optimizado para tiendas online con alto tráfico y transacciones.', cta: 'Elegir E-commerce', features: ['WordPress + WooCommerce', '50 GB almacenamiento SSD', 'SSL gratuito', 'Backups diarios + snapshots', '5 dominios incluidos', 'Soporte prioritario 24/7', 'WP-CLI vía SSH', 'Caché avanzada WordPress']},
...
export const contentEn: ContentTranslations = {
    ...
    plans: {
        ...
        'hosting-basico': {nombre: 'Basic', descripcion: 'WordPress pre-installed, ideal for personal sites and landing pages with moderate traffic.', cta: 'Get Started', features: ['WordPress pre-installed', '5 GB SSD storage', 'Free SSL', 'Weekly backups', '1 domain included', 'Chat support', 'WP-CLI via SSH', 'WordPress updates']},
        'hosting-pro': {nombre: 'Pro', descripcion: 'Optimized WordPress hosting for growing businesses that need performance and reliability.', cta: 'Choose Pro', features: ['WordPress pre-installed', '20 GB SSD storage', 'Free SSL', 'Daily backups', '3 domains included', 'Global CDN', 'WP-CLI via SSH', 'Staging environment']},
        'hosting-ecommerce': {nombre: 'E-commerce', descripcion: 'WordPress + WooCommerce optimized for online stores with high traffic and transactions.', cta: 'Choose E-commerce', features: ['WordPress + WooCommerce', '50 GB SSD storage', 'Free SSL', 'Daily backups + snapshots', '5 domains included', 'Priority 24/7 support', 'WP-CLI via SSH', 'Advanced WordPress cache']},
