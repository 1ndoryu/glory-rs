...
export const contentEs: ContentTranslations = {
    ...
    plans: {
        ...
        'hosting-basico': {nombre: 'Básico', descripcion: 'WordPress pre-instalado, ideal para sitios personales y landing pages con tráfico moderado.', cta: 'Comenzar', features: ['WordPress pre-instalado', '5 GB almacenamiento SSD', 'Tráfico ilimitado', 'Free temporary domain', 'Certificado SSL incluido', 'Free CDN', 'Backups semanales', 'WP-CLI + SSH']},
        'hosting-pro': {nombre: 'Pro', descripcion: 'WordPress optimizado para negocios en crecimiento que necesitan rendimiento y fiabilidad.', cta: 'Elegir Pro', features: ['WordPress pre-instalado', '20 GB almacenamiento SSD', 'Tráfico ilimitado', 'Free temporary domain', 'Certificado SSL incluido', 'Free CDN', 'Backups diarios', 'WP-CLI + SSH', 'Staging environment']},
        'hosting-ecommerce': {nombre: 'Avanzado', descripcion: 'WordPress administrado de mayor capacidad para sitios con más contenido, tráfico y caché avanzada.', cta: 'Elegir Avanzado', features: ['WordPress pre-instalado', '50 GB almacenamiento SSD', 'Tráfico ilimitado', 'Free temporary domain', 'Certificado SSL incluido', 'Free CDN', 'Backups diarios + semanales', 'Soporte prioritario 24/7', 'WP-CLI + SSH', 'Caché avanzada WordPress']},
        'hosting-custom': {nombre: 'A Medida', descripcion: 'WordPress con infraestructura personalizada para proyectos con necesidades específicas.', cta: 'Consultar', features: ['WordPress pre-instalado', '100+ GB almacenamiento', 'SSL gratuito', 'Backups bajo demanda', 'Soporte dedicado', 'WP-CLI + SSH', 'SLA personalizado']},
    },
    solutions: {
        ...
        hosting_normal: {titulo: 'Nginx Hosting', descripcion: 'Hosting administrado con Nginx, SSL y SFTP para sitios a medida, frontends y proyectos que no necesitan WordPress. Infraestructura mantenida por nosotros.', etiqueta: 'Desde $3.23/mes', features: {
            nginx: {titulo: 'Nginx optimizado', desc: 'Servidor web administrado para sitios estáticos, frontends y proyectos sin CMS pesado.'},
            security: {titulo: 'Seguridad incluida', desc: 'SSL gratuito, aislamiento por servicio, hardening SSH/SFTP y controles de acceso.'},
            uptime: {titulo: '99.9% Uptime', desc: 'Infraestructura preparada para disponibilidad estable y monitoreo operativo.'},
            domains: {titulo: 'Dominios y SSL', desc: 'Dominios propios con certificados automáticos y configuración limpia de DNS.'},
            sftp: {titulo: 'SFTP administrado', desc: 'Sube archivos del sitio por SFTP sin administrar servidores ni contenedores.'},
            support: {titulo: 'Soporte técnico', desc: 'Ayuda para publicar, diagnosticar DNS y mantener el sitio operativo.'},
        }},
...
export const contentEn: ContentTranslations = {
    ...
    plans: {
        ...
        'hosting-basico': {nombre: 'Basic', descripcion: 'WordPress pre-installed, ideal for personal sites and landing pages with moderate traffic.', cta: 'Get Started', features: ['WordPress pre-installed', '5 GB SSD storage', 'Unlimited traffic', 'Free temporary domain', 'Free SSL certificate', 'Free CDN', 'Weekly backups', 'WP-CLI + SSH']},
        'hosting-pro': {nombre: 'Pro', descripcion: 'Optimized WordPress hosting for growing businesses that need performance and reliability.', cta: 'Choose Pro', features: ['WordPress pre-installed', '20 GB SSD storage', 'Unlimited traffic', 'Free temporary domain', 'Free SSL certificate', 'Free CDN', 'Daily backups', 'WP-CLI + SSH', 'Staging environment']},
        'hosting-ecommerce': {nombre: 'Advanced', descripcion: 'Higher-capacity managed WordPress for content-heavy sites, traffic, and advanced cache.', cta: 'Choose Advanced', features: ['WordPress pre-installed', '50 GB SSD storage', 'Unlimited traffic', 'Free temporary domain', 'Free SSL certificate', 'Free CDN', 'Daily + weekly backups', 'Priority 24/7 support', 'WP-CLI + SSH', 'Advanced WordPress cache']},
        'hosting-custom': {nombre: 'Custom', descripcion: 'WordPress with personalized infrastructure for projects with specific needs.', cta: 'Get a Quote', features: ['WordPress pre-installed', '100+ GB storage', 'Free SSL', 'On-demand backups', 'Dedicated support', 'WP-CLI + SSH', 'Custom SLA']},
    },
    solutions: {
        ...
        hosting_normal: {titulo: 'Nginx Hosting', descripcion: 'Managed hosting with Nginx, SSL, and SFTP for custom sites, frontends, and projects that don\'t need WordPress. Infrastructure maintained by us.', etiqueta: 'From $3.23/mo', features: {
            nginx: {titulo: 'Optimized Nginx', desc: 'Managed web server for static sites, frontends, and projects without heavy CMS.'},
            security: {titulo: 'Security Included', desc: 'Free SSL, service isolation, SSH/SFTP hardening, and access controls.'},
            uptime: {titulo: '99.9% Uptime', desc: 'Infrastructure designed for stable availability and operational monitoring.'},
            domains: {titulo: 'Domains & SSL', desc: 'Custom domains with automatic certificates and clean DNS configuration.'},
            sftp: {titulo: 'Managed SFTP', desc: 'Upload site files via SFTP without managing servers or containers.'},
            support: {titulo: 'Technical Support', desc: 'Help publishing, diagnosing DNS, and keeping your site operational.'},
        }},
...
export const contentJa: ContentTranslations = {
    ...
    plans: {
        ...
        'hosting-basico': {nombre: 'ベーシック', descripcion: 'WordPressプリインストール済み。個人サイトやランディングページに最適。', cta: '始める', features: ['WordPressプリインストール', '5GB SSDストレージ', '無制限トラフィック', 'Free temporary domain', '無料SSL証明書', 'Free CDN', '週次バックアップ', 'WP-CLI SSHアクセス']},
        'hosting-pro': {nombre: 'プロ', descripcion: '成長中のビジネス向けに最適化されたWordPressホスティング。', cta: 'プロを選ぶ', features: ['WordPressプリインストール', '20GB SSDストレージ', '無制限トラフィック', 'Free temporary domain', '無料SSL証明書', 'Free CDN', '日次バックアップ', 'WP-CLI SSHアクセス', 'ステージング環境']},
        'hosting-ecommerce': {nombre: 'アドバンスド', descripcion: 'コンテンツ量とトラフィックが多いサイト向けの高容量WordPressホスティング。', cta: 'アドバンスドを選ぶ', features: ['WordPressプリインストール', '50GB SSDストレージ', '無制限トラフィック', 'Free temporary domain', '無料SSL証明書', 'Free CDN', '日次バックアップ＋スナップショット', '優先24/7サポート', 'WP-CLI SSHアクセス', 'WordPress高度キャッシュ']},
    ...
    solutions: {
        ...
        hosting_normal: {titulo: 'Nginx ホスティング', descripcion: 'Nginx、SSL、SFTPによるマネージドホスティング。WordPress不要のカスタムサイト、フロントエンド、プロジェクト向け。インフラは当社が管理。', etiqueta: '$3.23/月〜', features: {
            nginx: {titulo: '最適化Nginx', desc: '静的サイト、フロントエンド、重いCMSなしのプロジェクト向けマネージドウェブサーバー。'},
            security: {titulo: 'セキュリティ付帯', desc: '無料SSL、サービス分離、SSH/SFTPハーデニング、アクセス制御。'},
            uptime: {titulo: '99.9% アップタイム', desc: '安定した可用性と運用監視に設計されたインフラ。'},
            domains: {titulo: 'ドメイン＆SSL', desc: 'カスタムドメイン、自動証明書、クリーンなDNS設定。'},
            sftp: {titulo: 'マネージドSFTP', desc: 'サーバーやコンテナの管理不要でSFTP経由でサイトファイルをアップロード。'},
            support: {titulo: 'テクニカルサポート', desc: '公開、DNS診断、サイト稼働維持のサポート。'},
        }},
