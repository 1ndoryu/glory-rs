...
export const contentEs: ContentTranslations = {
    ...
    plans: {
        ...
        'hosting-basico': {nombre: 'Básico', descripcion: 'Ideal para sitios personales y landing pages con tráfico moderado.', cta: 'Comenzar', features: ['5 GB almacenamiento SSD', 'SSL gratuito', 'Backups semanales', '1 dominio incluido', 'Soporte por chat', 'CDN global', 'Staging environment', 'Soporte prioritario']},
        'hosting-pro': {nombre: 'Pro', descripcion: 'Para negocios en crecimiento que necesitan rendimiento y fiabilidad.', cta: 'Elegir Pro', features: ['20 GB almacenamiento SSD', 'SSL gratuito', 'Backups diarios', '3 dominios incluidos', 'Soporte por chat', 'CDN global', 'Staging environment', 'Soporte prioritario 24/7']},
        'hosting-ecommerce': {nombre: 'E-commerce', descripcion: 'Optimizado para tiendas online con alto tráfico y transacciones.', cta: 'Elegir E-commerce', features: ['50 GB almacenamiento SSD', 'SSL gratuito', 'Backups diarios + snapshots', '5 dominios incluidos', 'Soporte prioritario 24/7', 'CDN global', 'Staging environment', 'Optimización de caché avanzada']},
        'hosting-custom': {nombre: 'A Medida', descripcion: 'Infraestructura personalizada para proyectos con necesidades específicas.', cta: 'Consultar', features: ['100+ GB almacenamiento', 'SSL gratuito', 'Backups bajo demanda', 'Dominios ilimitados', 'Soporte dedicado', 'CDN global', 'Multi-region', 'SLA personalizado']},
    },
    solutions: {
        hosting: {titulo: 'Hosting Administrado', descripcion: 'Infraestructura de alto rendimiento con soporte 24/7, backups automáticos y optimización continua para que tu sitio nunca se detenga.', etiqueta: 'Desde $29/mes', features: {
            performance: {titulo: 'Alto Rendimiento', desc: 'Servidores SSD con última generación de hardware para tiempos de carga mínimos.'},
            security: {titulo: 'Seguridad Incluida', desc: 'SSL gratuito, firewall, backups automáticos y monitoreo 24/7.'},
            ...
            managed: {titulo: 'Administrado', desc: 'Actualizaciones, parches y optimizaciones sin que toques un servidor.'},
            support: {titulo: 'Soporte Experto', desc: 'Equipo técnico disponible para resolver cualquier incidencia rápidamente.'},
        }},
...
export const contentEn: ContentTranslations = {
    ...
    plans: {
        ...
        'hosting-basico': {nombre: 'Basic', descripcion: 'Ideal for personal sites and landing pages with moderate traffic.', cta: 'Get Started', features: ['5 GB SSD storage', 'Free SSL', 'Weekly backups', '1 domain included', 'Chat support', 'Global CDN', 'Staging environment', 'Priority support']},
        'hosting-pro': {nombre: 'Pro', descripcion: 'For growing businesses that need performance and reliability.', cta: 'Choose Pro', features: ['20 GB SSD storage', 'Free SSL', 'Daily backups', '3 domains included', 'Chat support', 'Global CDN', 'Staging environment', 'Priority 24/7 support']},
        'hosting-ecommerce': {nombre: 'E-commerce', descripcion: 'Optimized for online stores with high traffic and transactions.', cta: 'Choose E-commerce', features: ['50 GB SSD storage', 'Free SSL', 'Daily backups + snapshots', '5 domains included', 'Priority 24/7 support', 'Global CDN', 'Staging environment', 'Advanced cache optimization']},
        'hosting-custom': {nombre: 'Custom', descripcion: 'Personalized infrastructure for projects with specific needs.', cta: 'Get a Quote', features: ['100+ GB storage', 'Free SSL', 'On-demand backups', 'Unlimited domains', 'Dedicated support', 'Global CDN', 'Multi-region', 'Custom SLA']},
    },
    solutions: {
        hosting: {titulo: 'Managed Hosting', descripcion: 'High-performance infrastructure with 24/7 support, automatic backups, and continuous optimization so your site never stops.', etiqueta: 'From $29/mo', features: {
            performance: {titulo: 'High Performance', desc: 'SSD servers with latest-generation hardware for minimal load times.'},
            security: {titulo: 'Security Included', desc: 'Free SSL, firewall, automatic backups, and 24/7 monitoring.'},
            ...
            managed: {titulo: 'Fully Managed', desc: 'Updates, patches, and optimizations without touching a server.'},
            support: {titulo: 'Expert Support', desc: 'Technical team available to resolve any issue quickly.'},
        }},
...
export const contentJa: ContentTranslations = {
    ...
    plans: {
        ...
        'hosting-basico': {nombre: 'ベーシック', descripcion: '個人サイトやランディングページに最適。', cta: '始める', features: ['5GB SSDストレージ', '無料SSL', '週次バックアップ', 'ドメイン1つ付き', 'チャットサポート', 'グローバルCDN', 'ステージング環境', '優先サポート']},
        'hosting-pro': {nombre: 'プロ', descripcion: 'パフォーマンスと信頼性を必要とする成長中のビジネスに。', cta: 'プロを選ぶ', features: ['20GB SSDストレージ', '無料SSL', '日次バックアップ', 'ドメイン3つ付き', 'チャットサポート', 'グローバルCDN', 'ステージング環境', '優先24/7サポート']},
        'hosting-ecommerce': {nombre: 'Eコマース', descripcion: '高トラフィック・高トランザクションのオンラインストア向けに最適化。', cta: 'Eコマースを選ぶ', features: ['50GB SSDストレージ', '無料SSL', '日次バックアップ＋スナップショット', 'ドメイン5つ付き', '優先24/7サポート', 'グローバルCDN', 'ステージング環境', '高度なキャッシュ最適化']},
        'hosting-custom': {nombre: 'カスタム', descripcion: '特定のニーズを持つプロジェクト向けのカスタムインフラ。', cta: 'お見積もり', features: ['100GB以上のストレージ', '無料SSL', 'オンデマンドバックアップ', '無制限ドメイン', '専任サポート', 'グローバルCDN', 'マルチリージョン', 'カスタムSLA']},
    },
    solutions: {
        hosting: {titulo: 'マネージドホスティング', descripcion: '24時間365日サポート、自動バックアップ、継続的な最適化を備えた高パフォーマンスインフラ。', etiqueta: '$29/月〜', features: {
            performance: {titulo: 'ハイパフォーマンス', desc: '最新世代ハードウェアの SSD サーバーで最小のロード時間を実現。'},
            security: {titulo: 'セキュリティ込み', desc: '無料SSL、ファイアウォール、自動バックアップ、24時間365日モニタリング。'},
            uptime: {titulo: '99.9% アップタイム', desc: '自動フェイルオーバー付きの冗長インフラで最高の可用性を保証。'},
            cdn: {titulo: 'グローバルCDN', desc: 'あらゆる場所から最適な速度を実現するコンテンツ配信ネットワーク。'},
            managed: {titulo: 'フルマネージド', desc: 'サーバーに触れることなく、アップデート、パッチ、最適化を実施。'},
            support: {titulo: 'エキスパートサポート', desc: 'あらゆる問題を迅速に解決する技術チーム。'},
        }},
