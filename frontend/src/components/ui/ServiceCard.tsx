...
interface ServiceCardProps {
    ...
    noOverlay?: boolean; /* [204A-7] Desactiva AdminOverlay en contextos públicos (home, relacionados) */
}

/* [064A-64] Titulo y descripcion traducidos via content translations */
export const ServiceCard: React.FC<ServiceCardProps> = ({servicio, variant = 'simple', noOverlay = false}) => {
        ...
        const card = (
            <a href={servicio.link} className="serviceCard detailed" onClick={e => spaClick(e, servicio.link)}>
                <div className="cardImageWrapper">
                    <OptimizedImage src={servicio.imagen} alt={titulo} className="cardImage" width={640} height={640} sizes="(max-width: 768px) 100vw, 50vw" />
