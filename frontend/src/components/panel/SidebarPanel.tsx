...
import {FolderOpen, Briefcase, Receipt, User, CreditCard, ClipboardList, PackageOpen, Users, Settings, LayoutDashboard, ArrowLeftRight, ArrowRightLeft, MessageSquare} from 'lucide-react';
