/* [044A-38 Fase 2] Detalle de una orden con timeline de fases.
 * Muestra info general + fases con acciones según rol.
 * Componente extraído de SeccionProyectos para cumplir límite 300 líneas. */
import React from 'react';
import {Check, RotateCcw, Package} from 'lucide-react';
import {
    ORDER_STATUS_LABELS,
    PHASE_STATUS_LABELS,
    PAYMENT_MODE_LABELS,
...
export const OrdenDetalle: React.FC<OrdenDetalleProps> = ({
    order, phases, effectiveRole, onVolver, onCancelar, onAprobar, onRevision, onEntregar, cancelando,
}) => {
...
function FaseCard({phase, orderId, isLast, isClient, isEmployee, onAprobar, onRevision, onEntregar}: {
