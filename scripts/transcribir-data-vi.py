"""
Transcripcion de archivos multimedia de cliente/Data VI usando Groq Whisper API.
Procesa .mp4 y .ogg. Resultados en cliente/Data VI/transcripciones-data-vi.md
...
CARPETA = Path(__file__).parent.parent / "cliente" / "Data VI"
SALIDA = CARPETA / "transcripciones-data-vi.md"
...
def main():
    ...
    if es_nuevo:
        with open(SALIDA, "w", encoding="utf-8") as f:
            f.write("# Transcripciones Data VI\n\n")
